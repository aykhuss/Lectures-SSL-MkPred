...
#+begin_src python :results silent :python python3.10
import lhapdf
import numpy as np
...
#+begin_src gnuplot :var data=lhapdf_xfx(3,0) :var fac=1 :file pdf_xfx.png
reset
...
#+HEADER: :var q=100
#+begin_src python :results value :exports both :python python3.10
import lhapdf
import math
import scipy
lhapdf.setVerbosity(0)
